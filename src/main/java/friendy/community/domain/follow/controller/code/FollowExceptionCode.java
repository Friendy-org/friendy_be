...
public enum FollowExceptionCode implements ExceptionCode {
    ...
    MEMBER_NOT_FOUND(4603, "해당 ID의 회원을 찾을 수 없습니다."),
    SELF_FOLLOW_NOT_ALLOWED(4604, "자기 자신을 대상으로 수행할 수 없습니다."),
    FOLLOWING_MEMBER_NOT_FOUND(4605, "팔로잉 멤버가 없습니다."),
    FOLLOWER_MEMBER_NOT_FOUND(4606, "팔로워 멤버가 없습니다.");
